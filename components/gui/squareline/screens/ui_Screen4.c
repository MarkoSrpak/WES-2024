...
void ui_Screen4_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_Screen4, lv_color_hex(0x102462),
    ...
    lv_label_set_text(ui_Label9, "YOU WIN!");
    lv_obj_set_style_text_color(ui_Label9, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
